export function SiteNav() {
  return <>
    ...
    <div className="wa-widget" id="wa-widget">
      ...
      <button className="wa-button" id="wa-button" aria-label="Chat on WhatsApp" onClick="document.getElementById('wa-panel').classList.toggle('wa-panel-open');this.classList.toggle('wa-button-open');">
...
export function SiteFooter() {
  return <footer className="site-footer"><div><a className="brand" href="/"><img src="/logo.svg" alt="MTT Packaging" width="72" height="52"/><b>MTT Packaging</b></a><p>Custom luxury packaging manufacturer in China. Rigid boxes, perfume packaging, cosmetic packaging and premium gift boxes.</p></div><div><b>Products</b><a href="/packaging">All Packaging</a><a href="/industries/perfume-fragrance-packaging">Perfume Packaging</a><a href="/industries/cosmetics-skincare-packaging">Cosmetic Packaging</a><a href="/industries/jewelry-watch-packaging">Jewelry Packaging</a></div><div><b>Resources</b><a href="/insights">Packaging Guide</a><a href="/how-we-work">How We Work</a><a href="/sustainability">Sustainability</a><a href="/sitemap.xml">Sitemap</a></div><div><b>Contact</b><a href="mailto:info@mttpackaging.com">info@mttpackaging.com</a><a href="https://wa.me/8617207110964" target="_blank" rel="noreferrer">WhatsApp</a><a href="/request-a-quote">Request a Quote</a></div></footer>;
}
