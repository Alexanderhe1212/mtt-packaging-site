...
export function discoveryText(){
 const pages=[
  ...
  ['Design Your Box','/tools/gift-box-solution-builder','Choose a structure and prepare a design brief; engineering review is required.'],
