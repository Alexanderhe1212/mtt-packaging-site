...
const topics = [
  ...
  {articles:['custom-box-structure-guide','rigid-box-vs-folding-carton','window-carton-presentation-analysis','fold-flat-triangular-gift-box-shipping-volume'], products:['signature-perfume-lift-off','window-bakery-folding-carton','custom-corrugated-packaging-set']},
