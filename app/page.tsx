...
export default function Home() {
  return <main className="home-v2">
    ...
    <nav className="nav" aria-label="Primary navigation">
      ...
      <div className="navlinks"><a href="/packaging">Products</a><a href="#industries">Industries</a><a href="/how-we-work">Process</a><a href="/insights">Packaging Guide</a><a href="/request-a-quote">Contact</a></div>
    ...
    <section className="v2-hero" id="top"><div><p className="eyebrow">MTT Packaging · Custom Luxury Packaging Manufacturer</p><h1>Custom Luxury Packaging<br/>Manufacturer <em>in China</em></h1><p>Custom rigid boxes, perfume packaging, cosmetic packaging and premium gift boxes for growing brands worldwide.</p><div className="v2-hero-trust"><span>MOQ from 500 pcs</span><span>Custom Structure &amp; Inserts</span><span>Sampling Before Production</span><span>Worldwide Shipping</span></div><div className="actions"><a className="button" href="/request-a-quote">Request a Quote →</a><a className="text-link" href="#projects">View Packaging Projects ↓</a></div></div><div className="v2-hero-image"><img src="/capability-rigid-box.webp" alt="Custom luxury rigid perfume box with fitted insert - MTT Packaging" width="1000" height="1000"/><span>Rigid structure · Precision insert · Premium finish</span></div></section>
