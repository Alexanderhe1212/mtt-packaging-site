...
const families={rigid:['lift-off','drawer','shoulder','book'],carton:['tuck'],corrugated:['mailer'],bag:['ribbon-bag']};
...
console.log(all.length+' products across four families; new structures, bilingual fields and 35 image assets passed.');
